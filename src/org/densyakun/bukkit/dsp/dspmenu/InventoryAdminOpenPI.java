...
public class InventoryAdminOpenPI extends MenuInventory {
	DSPMenu dspme;
	public InventoryAdminOpenPI(DSPMenu dspme) {
		super(dspme, 54, "管理者専用 > プレイヤーのインベントリを開く");
		this.dspme = dspme;
	...
	public void Click(InventoryClickEvent e) {
		...
		default:
			if (e.getInventory().getItem(e.getRawSlot()) != null) {
				...
				if (player != null) {
					e.getWhoClicked().openInventory(player.getPlayer().getInventory());
					player = null;
				} else {
